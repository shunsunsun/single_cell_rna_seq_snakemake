...
infile=args[1]
tmpfile1 <- gsub(".rds","rogue.rda",infile)
tmpfile2 <- gsub(".rds","roguePlots.rda",infile)
logfile <- paste0("/gpfs2/gaog_pkuhpc/users/liny/GEJ_singleCell/log/",gsub(".rds","_rogue.log",basename(infile)))
