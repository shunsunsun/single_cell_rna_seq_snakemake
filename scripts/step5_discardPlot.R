...
###!!!! The filtering strategies below are outdated. See step5_removeOutliers.R and step5_removeOutliers_pipeComp.R for the actually used. 
###The important thing is, if you want to make plots, mark instead of removing outliers (e.g., store info in a field named "discard")
...
##This chunk of code can only apply to all samples, not a subset of them
