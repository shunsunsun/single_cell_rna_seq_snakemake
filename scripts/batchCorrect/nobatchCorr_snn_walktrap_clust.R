...
se <- readRDS(file="/gpfs2/gaog_pkuhpc/users/liny/GEJ_singleCell/data/GEJ_QCed_sctNorm_noBatchCorr_clustered.rds")
se <- DietSeurat(se, assays='SCT', dimreducs='pca')
...
saveRDS(sce, file="/gpfs2/gaog_pkuhpc/users/liny/GEJ_singleCell/data/GEJ_QCed_sctNorm_noBatchCorr_walktrap_clustered.rds")
