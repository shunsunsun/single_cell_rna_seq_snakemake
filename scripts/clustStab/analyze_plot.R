...
#indir <- "/gpfs2/gaog_pkuhpc/users/liny/GEJ_singleCell/"
#prefix <- "GEJ_QCed_sctNorm_BatchCCA"
#se <- readRDS(file=paste0(indir, "data/", prefix, ".rds"))
#subsample_idents <- readRDS(file=paste0(indir, "data/", prefix, "_clustStab/gather_subsample.rds"))
#fullsample_idents <- readRDS(file=paste0(indir, "data/", prefix, "_clustStab/gather_full_sample.rds"))

full_rds <- snakemake@input[["full"]]
